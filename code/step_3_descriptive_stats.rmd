...
kissing_dat |>
  ...
  count(waveform, voltage, pulse_seq, application_num) |> left_join(
    # Add in basic stats for depth/diameter
    kissing_dat |>
      filter(dimension == "depth") |> group_by(waveform, voltage, pulse_seq, application_num) |>
      summarise(
...
kissing_dat |>
  ...
  count(waveform, voltage, pulse_seq, application_num) |> left_join(
    # Add in basic stats for depth/diameter
    kissing_dat |>
      filter(dimension == "diameter") |> group_by(waveform, voltage, pulse_seq, application_num) |>
      summarise(
