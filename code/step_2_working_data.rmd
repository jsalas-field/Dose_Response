...
# Import Processed VCAS and PULSE Labs Data

```{r}
load("~/R_Projects/VCAS1_prelim_labs/data/processed/working_stats.RData")
VCAS_hemolysis_perc_change <- hemolysis_perc_change
load("~/R_Projects/PULSE_prelim_labs/data/processed/working_stats.RData")
PULSE_hemolysis_perc_change <- hemolysis_perc_change

rm(cleaned_res, cleaned_res_1, headers, hemolysis_dat, hemolysis_perc_change)
```
...
# Combine Hemolysis Percent Change 

```{r}
combined_hemolysis_perc_change <- 
  bind_rows(VCAS_hemolysis_perc_change |> mutate(study = "VCAS") |> rename(sum_applications = numberapplications),
      PULSE_hemolysis_perc_change |> mutate(study = "PULSE")) 
```
...
```{r}
save(combined_hemolysis_perc_change, 
     file = paste0("data/processed/combined_hemolysis_dat.RData"))
```
